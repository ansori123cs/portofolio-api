...
# Production deployment script for Portofolio App
# This script starts the application in production mode with Neon Cloud Database

echo "🚀 Starting Portofolio App in Production Mode"
echo "==============================================="
...
echo "   Logs: docker logs portofolioapp-prod"
echo ""
echo "Useful commands:"
echo "   View logs: docker logs -f portofolioapp-prod"
